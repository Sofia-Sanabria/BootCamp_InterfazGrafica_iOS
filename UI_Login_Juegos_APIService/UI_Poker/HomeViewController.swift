...
//
//  View Controller que contiene el Home para seleccionar los juegos
//
...
class HomeViewController: UIViewController {
    ...
    @IBAction func puntajesButton(_ sender: UIButton) {
        ...
        // Mostrar solo los puntajes del jugador que inició sesión
        puntajesVC.mostrarSoloJugador = true
        puntajesVC.cantidadTop = 5

        // Asignar el nombre directamente desde la sesión guardada
        // puntajesVC.nombreJugador = SesionUsuario.shared.nombre ?? "Jugador"
    ...
    @IBAction func playGame(_ sender: UIButton) {
        ...
        case "Poker":
            ...
            if let pokerVC = storyboard.instantiateViewController(withIdentifier: "pokerVC") as? PokerViewController {
                pokerVC.jugador1Text = SesionUsuario.shared.nombre ?? "Jugador"
        ...
        case "Tócame":
            ...
            if let touchVC = storyboard.instantiateViewController(withIdentifier: "touchButtonVC") as? TocameViewController {
                touchVC.jugador1Text = SesionUsuario.shared.nombre ?? "Jugador"
