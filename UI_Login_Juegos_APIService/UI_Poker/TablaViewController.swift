...
//
//  View Controller contiene la tabla donde se muestran los puntajes del juego Tocame
//
...
class TablaViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func cargarPuntajesDesdeAPI() {
        ...
        // Verificar que haya un token y userID guardado en UserDefaults
        ...
        // Llamar al método de APIService que obtiene los puntajes del juego
                ...
                case .success(let todosLosPuntajes):
                    ...
                    if self?.mostrarSoloJugador == true {
                        self?.mejoresPuntajes = todosLosPuntajes
                            .filter { $0.user_id == userID } // Filtrar por nombre exacto
...
extension TablaViewController {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let nombre = obtenerNombreLocal(userID: entrada.user_id)
